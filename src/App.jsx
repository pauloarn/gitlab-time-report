		...
		<div className='min-h-screen bg-gradient-to-b from-blue-50 to-white p-1'>
			...
			>
				<div className='text-center space-y-4'>
					...
					<p className='text-gray-600'>Gere relatórios detalhados de horas trabalhadas do GitLab</p>
				</div>
					...
					items={[
						{
							...
							component: (
								<TimeLogTable
									data={[
										...timeLogs,
										{ dataTrack: [{ description: 'Total', timeLoggedInSeconds: totalTime }] },
									]}
						...
						},
						{
							title: 'Insights',
							component: (
								<InsightsTable data={insights} selectedDate={selectedDate} hollidays={hollidays} />
							),
						},
						{
							title: 'Horas Úteis',
							component: <BusinessHours selectedDate={selectedDate} totalTime={totalTime} />,
						},
					]}
				/>
			)}
